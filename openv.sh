...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
		...
		case $option in
			...
			newclient "$CLIENT"
			echo ""
			echo "O usuário $CLIENT foi adicionado, disponível em ~/$CLIENT.ovpn"
			exit
			;;
			2)
	...
	tput setaf 6 ; echo "Traduzido e adaptado para o protocolo TCP por @Lucasfer97"
